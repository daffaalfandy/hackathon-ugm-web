  ...
  <div class="container-fluid shadow">
    <div class="row">
      ...
      <div class="col-md-8 col-sm-12">
        ...
        <p class="subtitle-theme">
          Inovasi teknologi yang dapat membantu mahasiswa UGM dalam berbagai kegiatan
          akademik, seperti pelaksanaan perkuliahan, praktikum, dan penugasan kuliah.
        </p>
        <hr class="subtheme" />
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-8 col-sm-12">
        ...
        <p class="subtitle-theme">
          Inovasi teknologi berbasis aplikasi atau web yang dapat mengakses berbagai
          layanan kesehatan UGM secara daring dan efisien sehingga meminimalisir potensi pelang- garan
          protokol kesehatan pada era pandemi COVID-19.
        </p>
        <hr class="subtheme" />
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-8 col-sm-12">
        ...
        <p class="subtitle-theme">
          Inovasi teknologi yang dapat meningkatkan kualitas inter- aksi antar
          mahasiswa UGM secara daring melalui permain- an atau hiburan yang dapat diakses bersama.
        </p>
        <hr class="subtheme" />
      </div>
    </div>
